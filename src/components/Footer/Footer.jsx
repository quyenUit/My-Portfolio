    ...
    <Container id="footer">
      <Profile>
        ...
        <div className="address">
          ...
          <Slide direction="left">
            <p>3/25 Nguyen Thi Sau Street, Thanh Loc Ward, District 12, Ho Chi Minh, Vietnam</p>
          </Slide>
        </div>
        <div className="links">
          <Slide direction="left">
          ...
          <div>
            ...
            <Slide direction="left">
              <a href="tel:+4733378901">0348112766</a>
            </Slide>
          </div>
          <div>
            <Slide direction="left">
            ...
            <Slide>
              <a href="mailto:miladamiri@gmail.com">quyennh282@gmail.com</a>
            </Slide>
          </div>
        </div>
